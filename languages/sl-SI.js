...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		this.language = {
			WARNINGS: 'Opozorila',
			AFK_HELP_DESCRIPTION: 'Vklopi/Izklopi ali nastavi AFK sporočilo zase.',
			AFK_HELP_EXTENDED: prefix =>
				[
					`**${prefix}afk** bo vklopilo ali izklopilo tvoje AFK sporočilo.`,
					`**${prefix}afk (tvoje AFK sporočilo tukaj)** bo nastavilo tvoje AFK sporočilo, ki bo poslano.`,
					'',
					'Napredno: Lahko si tudi nastaviš AFK sporočilo z lastnim embedom!'
				].join('\n'),
